...
export class RequestsService {
  ...
  getRequestsByEventId(eventId: string, status: string) {
    ...
    return this.http.get(`${environment.eventsUrl}/${eventId}/requests/?status=${status}`, headers)
  }
  ...
  getAllRequestsByEventId(eventId: string) {
    ...
    return this.http.get(`${environment.eventsUrl}/${eventId}/requests`, headers);
  }

  changeRequestStatus(request: Requests, requestId: string | number) {
